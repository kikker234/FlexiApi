...
public abstract class TestClass
{
    ...
    public HttpClient GetClient()
    {
        if (_client == null)
        {
            ...
            _client.DefaultRequestHeaders.Add("Instance", "1e303b04-9f1a-46b9-af9f-63c2f95bbfdd");
        }
    ...
    public void Login()
    {
        try
        {
            var url = "/api/auth?email=admin@admin.com&password=Hoezo999!";
            ...
            if (response.StatusCode == HttpStatusCode.BadRequest)
            {
                ...
                loginAttempts++;
                Login(); // Retry login after registration
                return;
            }
